...
export const AlertDialogTrigger = memo(
  forwardRef<HTMLElement, AlertDialogTriggerProps>(
...
export const AlertDialogPortal = memo(function AlertDialogPortal({
  children,
  container,
...
export const AlertDialogHeader = memo(
  forwardRef<HTMLDivElement, AlertDialogHeaderProps>(
...
export const AlertDialogTitle = memo(
  forwardRef<HTMLHeadingElement, AlertDialogTitleProps>(
    ({ children, className }, ref) => {
      return (
...
export const AlertDialogDescription = memo(
  forwardRef<HTMLParagraphElement, AlertDialogDescriptionProps>(
    ({ children, className }, ref) => {
      return (
...
export const AlertDialogFooter = memo(
  forwardRef<HTMLDivElement, AlertDialogFooterProps>(
    ({ children, className }, ref) => {
      return (
        <div
          ref={ref}
    ...
    ({ children, asChild = false, className, onClick, disabled }, ref) => {
      ...
      return (
        <button
          ...
          disabled={disabled}
          className={cn(
            'inline-flex h-10 items-center justify-center rounded-lg bg-destructive px-4 py-2 text-sm font-semibold text-destructive-foreground ring-offset-white transition-colors hover:bg-destructive/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-destructive focus-visible:ring-offset-2 cursor-pointer disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed',
            className,
          )}
        >
          {children}
...
export const AlertDialogCancel = memo(
  forwardRef<HTMLButtonElement, AlertDialogCancelProps>(
    ({ children, asChild = false, className, onClick, disabled }, ref) => {
      const { setOpen } = useAlertDialogContext()
      ...
      return (
        <button
          ...
          disabled={disabled}
          className={cn(
            'mt-2 inline-flex h-10 items-center justify-center rounded-lg border border-border bg-card px-4 py-2 text-sm font-semibold text-foreground ring-offset-white transition-colors hover:bg-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-muted-foreground focus-visible:ring-offset-2 cursor-pointer disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed sm:mt-0',
            className,
          )}
        >
          {children}
