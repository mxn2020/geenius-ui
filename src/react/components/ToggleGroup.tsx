...
export const ToggleGroupItem = memo(
  forwardRef<HTMLButtonElement, ToggleGroupItemProps>(
    (
      {
        children,
        value: itemValue,
      ...
      return (
        <button
          ...
          className={cn(
            ...
            'focus:z-10 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-0',
