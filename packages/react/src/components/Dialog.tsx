...
export const DialogTrigger = memo(
  forwardRef<HTMLButtonElement, DialogTriggerProps>(
...
export const DialogPortal = memo(function DialogPortal({
  children,
  container,
}: DialogPortalProps) {
...
export const DialogOverlay = memo(
  forwardRef<HTMLDivElement, DialogOverlayProps>(({ className }, ref) => {
    const { setOpen } = useDialogContext()
        ...
        <DialogPortal>
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
              ...
              className={cn(
                `relative z-50 grid w-full max-w-lg gap-4 border bg-card p-6 shadow-lg ${borderRadius.default}`,
...
export const DialogHeader = memo(
  forwardRef<HTMLDivElement, DialogHeaderProps>(
...
export const DialogTitle = memo(
  forwardRef<HTMLHeadingElement, DialogTitleProps>(
    ({ children, className }, ref) => {
      return (
        <h2
          ref={ref}
...
export const DialogDescription = memo(
  forwardRef<HTMLParagraphElement, DialogDescriptionProps>(
    ({ children, className }, ref) => {
      return (
...
export const DialogFooter = memo(
  forwardRef<HTMLDivElement, DialogFooterProps>(
    ({ children, className }, ref) => {
      return (
        <div
          ref={ref}
...
export const DialogClose = memo(
  forwardRef<HTMLButtonElement, DialogCloseProps>(
    ({ children, asChild = false, className }, ref) => {
      const { setOpen } = useDialogContext()
