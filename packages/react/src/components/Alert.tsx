...
export const AlertDescription = memo(
  forwardRef<HTMLParagraphElement, AlertDescriptionProps>(
    ({ children, className }, ref) => {
      return (
...
export const CompoundAlert = memo(
  forwardRef<HTMLDivElement, CompoundAlertProps>(
    (
      { children, variant = 'default', title, showIcon = true, className },
      ref,
    ) => {
      return (
