...
export const DateTimePicker = memo(
  forwardRef<ElementRef<'button'>, DateTimePickerProps>((props, ref) => {
    const {
      label,
      error,
      helpText,
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <button
              ...
              className={cn(
                'flex items-center justify-between w-full border border-border rounded-lg shadow-sm focus:ring-2 focus:ring-primary focus:border-primary disabled:bg-surface disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors bg-card',
                sizeClasses[size],
                hasError &&
              ...
              <div className="border-t border-border p-4 bg-surface">
                <div className="flex items-center justify-center gap-2">
                  <div className="flex items-center gap-1">
                    ...
                    <input
                      ...
                      className="w-12 px-2 py-1 text-center border border-border rounded focus:ring-2 focus:ring-primary focus:border-primary"
                  ...
                  {!format24Hour && (
                    <button
                      ...
                      className="px-3 py-1 text-sm font-medium border border-border rounded bg-card hover:bg-surface focus:ring-2 focus:ring-primary focus:border-primary transition-colors"
                    >
                      {ampm}
                    </button>
                  )}
                ...
                <div className="mt-2 flex justify-end">
                  <button
                    ...
                    className="px-3 py-1 text-sm font-medium text-primary-foreground bg-primary rounded hover:bg-primary/90 focus:ring-2 focus:ring-primary transition-colors"
                  >
                    {labels.done}
                  </button>
                </div>
