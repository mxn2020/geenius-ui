  ...
  return (
    <div className={containerClass}>
      <Card className="w-full">
        <CardContent className={compact ? 'py-8' : 'py-12'}>
          {content}
        </CardContent>
      </Card>
    </div>
...
export const NoSearchResults: FC<Omit<EmptyStateProps, 'variant' | 'icon'>> = (
  props,
) => (
  <EmptyState
    {...props}
...
export const NoFilterResults: FC<Omit<EmptyStateProps, 'variant' | 'icon'>> = (
  props,
) => (
  <EmptyState
    {...props}
    ...
    description={
      props.description ||
      'No items match your current filters. Try clearing some filters.'
    }
  />
)
