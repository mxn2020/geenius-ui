...
export const SectionTitle = memo(
  forwardRef<HTMLHeadingElement, SectionTitleProps>(
    ({ children, className, size = 'md', as: Component = 'h2' }, ref) => {
      return (
        <Component
          ref={ref}
          className={cn('text-foreground', titleSizeClasses[size], className)}
        >
          {children}
        </Component>
      )
...
export const SectionDescription = memo(
  forwardRef<HTMLParagraphElement, SectionDescriptionProps>(
...
export const SectionContent = memo(
  forwardRef<HTMLDivElement, SectionContentProps>(
...
export const CompoundSection = memo(
  forwardRef<HTMLElement, CompoundSectionProps>(
    (
      {
        children,
        title,
